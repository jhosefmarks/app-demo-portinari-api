const metadata = [
  {
    ...
    fields: [
      ...
      { property: 'city', label: 'Cidade', required: true, gridColumns: 3, optionsService: 'https://app-demo-portinari-api.herokuapp.com/api/samples/v1/cities', params: { transform: true } },
